...
if __name__ == '__main__':
    ...
    while True:
        if tape.read() == '0':
            ...
            if tape.read() == '0' or tape.read() == '1':
                tape.move_head(Direction.RIGHT)
            elif tape.read() == 'x' or tape.read() == 'y':
                break

            while tape.read() == '0' or tape.read() == '1':
                tape.move_head(Direction.RIGHT)

            if tape.read() == 'd' or tape.read() == 'x' or tape.read() == 'y':
        ...
        elif tape.read() == 'd' or tape.read() == 'x' or tape.read() == 'y':
            break
